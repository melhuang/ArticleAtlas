# Project 2 - *ArticleAtlas*

**ArticleAtlas** is an android app that allows a user to search for articles on web using simple filters. The app utilizes [New York Times Search API](http://developer.nytimes.com/docs/read/article_search_api_v2).
...
http://imgur.com/a/3jBsy

D: 
<img src='http://i.imgur.com/a/3jBsy.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
Spent 4 hours trying to put an icon on the toolbar. Did it in lab with no problem but for some reason couldn't render properly here. :(
